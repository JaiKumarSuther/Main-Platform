...
const rooms = [
  {
    ...
    title: 'Deluxe Room',
    sleeps: 'Sleeps 3',
    bedType: '1 Single Bed · 1 King Bed',
    roomSize: '159 sq ft',
    cancellationDate: '6th May',
    price: 'PKR 4840',
    nights: '2',
...
<template>
  <main>
    <SidebarMobile />
    <HotelListingDetails
      title="North View Hotel"
      price="PKR 4840"
      location="Hunza"
      mainImage="/src/images/northview.png"
      :galleryImages="[
    ...
    <div class="hotel-info-details">
      <div class="hotel-info">
        <HotelHeader
          ...
          :amenitiesList1="[
            { icon: '/src/images/resturant icon.svg', label: 'Restaurant' },
            {
              icon: '/src/images/room service icon.svg',
              label: 'Room service',
            },
            {
              icon: '/src/images/Free parking icon.svg',
              label: 'Free Parking',
            },
            { icon: '/src/images/For ages icon.svg', label: 'Family Friendly' },
          ]"
          :amenitiesList2="[
            {
              icon: '/src/images/Places icon in mobile menu.svg',
              label: 'Free Wi-fi',
            },
            { icon: '/src/images/river view icon.svg', label: 'River View' },
            { icon: '/src/images/activity type icon.svg', label: 'Lobby' },
          ]"
          checkInTime="12PM - Anytime"
          checkOutTime="11AM"
        />
          ...
          :items="[
            {
              ...
              answer:
                'Call our 24/7 support. Roadside assistance or a replacement will be arranged.',
            },
            {
            ...
            {
              question:
                'Is there a security deposit required, and how much is it?',
              answer: 'Yes. Details vary by vehicle type and rental duration.',
            },
            {
              question:
                'Can I pick up the car from one location and return it to another?',
    ...
    <div class="mobile-sticky-panel hotel-select-details">
      <div class="left-text">
