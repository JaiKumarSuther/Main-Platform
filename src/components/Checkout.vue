    ...
    <div class="checkout-container">
      <div class="left-section">
        ...
        <div class="payment-form">
          ...
          <label class="payment-option">
            ...
            <img
              src="/src/images/easypaisa icon checkout.svg"
              alt="Easypaisa"
            />
          </label>
          ...
          <div class="card-section">
            <label class="payment-option card-label">
              ...
              <div class="card-logos">
                <img
                  src="/src/images/mastercard-svgrepo-com (1).svg"
                  alt="MasterCard"
                />
                <img src="/src/images/visa-svgrepo-com.svg" alt="Visa" />
                <img
                  src="/src/images/unionpay.svg"
                  alt="UnionPay"
                  class="union-pay"
                />
              </div>
      ...
      <div class="right-section">
        ...
        <div class="booking-card">
          ...
          <div class="details">
            <p class="duration">
              <img src="/src/images/Duration icon.svg" alt="" /> Duration
            </p>
            <span>14 days</span>
          </div>
          <div class="details">
          ...
          <div class="details">
            <p class="people">
              <img
                src="/src/images/people icon checkout page.svg"
                alt=""
              />People
            </p>
          ...
          <p class="cancellation">
            <img src="/src/images/Free cancellation icon.svg" alt="" /> Cancel
            for free until
