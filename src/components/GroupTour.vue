<template>
  <main>
    <div class="slider-mobile">
      <img class="slide" src="/src/images/hunza tour.png" alt="Slide 1" />
    ...
    <div class="listing-details">
      <div class="listing-header">
        <section class="listing-header-details">
          <h1>9 Day Hunza Valley: A Cultural & Scenic Odyssey</h1>
          <p>From <span class="price">$1200</span></p>
        </section>
      ...
      <section class="gallery">
        <div class="main-image">
          <img src="/src/images/hunza tour.png" alt="Main Tour Image" />
        </div>
        <div class="side-images">
          <img src="/src/images/2211.jpg" alt="Image 1" />
          <img src="/src/images/45497.jpg" alt="Image 2" />
          <img src="/src/images/17940.jpg" alt="Image 3" />
          <img src="/src/images/26240.jpg" alt="Image 4" />
        </div>
      </section>
    </div>
    <div class="listing-info-details">
      <div class="listing-info">
        ...
        <div class="details">
          ...
          <div class="detail-item">
            <img
              src="/src/images/Tour theme and experience type icon.svg"
              alt=""
              width="16"
            />
            <div class="detail-text">
        ...
        <div class="review-cont">
            ...
            <div class="review-heading">
              ...
              <div class="review-no">
                <div class="review-stars">
                  ...
                  <img src="/src/images/Review icon.svg" alt="" />
                  <img src="/src/images/Review icon.svg" alt="" />
                  <img src="/src/images/Half filled star.svg" alt="" />
          ...
          <div class="reviews">
            <div class="review-list">
              <div class="avatar">
                <img src="/src/images/auto-generate.jpg" alt="User Avatar" />
              </div>
              <div>
            ...
            <div class="review-media" id="openPopup">
          ...
          <div class="reviews">
            <div class="review-list">
              <div class="avatar">
                <img src="/src/images/auto-generate 2.svg" alt="User Avatar" />
              </div>
              <div>
                <div class="review-info">
          ...
          <div class="no-border reviews">
            <div class="review-list">
              <div class="avatar">
                <img src="/src/images/auto-generate 3.svg" alt="User Avatar" />
              </div>
              <div>
                <div class="review-info">
    ...
    <div id="customPopup" class="photos-popup-overlay">
      <div class="photos-popup-content">
        <div class="photos-popup-header">
          <h2>Photos</h2>
          <svg
            id="closePopup"
            width="100"
