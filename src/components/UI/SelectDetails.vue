  ...
  <div class="booking">
    ...
    <div class="dropdown-container">
      ...
      <div class="pick-and-drop">
        <div class="dropdown">
          <img src="/src/images/Pickup dropoff time icon.svg" alt="Pickup" class="icon" />
          <div class="dropdown-content">
            <label>Pickup</label>
            <span>{{ pickupTime }}</span>
          </div>
          <img src="/src/images/dropdown toggle.svg" alt="Arrow" class="arrow" />
        </div>
        <div class="dropdown">
          <img src="/src/images/Pickup dropoff time icon.svg" alt="Dropoff" class="icon" />
          <div class="dropdown-content">
            <label>Dropoff</label>
    ...
    <div class="price-summary">
      ...
      <p class="cancellation">
        <img src="/src/images/Free cancellation icon.svg" alt="" />
