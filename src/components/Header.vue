  ...
  <header>
    ...
    <div class="desktop-header">
      <div class="header-left">
        <div class="logo">
          <img src="/src/images/NINJA logo.svg" alt="Travel Ninja Logo" />travelninja
        </div>
      ...
      <div class="header-right">
        ...
        <div class="header-icons">
          <div class="menu">
            <img src="/src/images/currency icon.svg" alt="" /><span
              >US Dollar</span
            >
          </div>
          <div class="menu">
            <img src="/src/images/support icon.svg" alt="" /><span
              >Support</span
            >
          </div>
          <img src="/src/images/Save Icon (listing page & Header).svg" alt="" />
          <img src="/src/images/Profile icon.svg" alt="" />
        </div>
      </div>
    </div>
    ...
    <div class="mobile-header">
      <div class="mobile-header-container">
        <div class="logo-section">
          <img
            src="/src/images/travelninja.png"
        ...
        <div class="icon-section">
          <img
            src="/src/images/Search bar icon.svg"
            alt="Search"
            class="header-icon"
          />
          <img
          ...
          />
          <img
            src="/src/images/Profile icon.svg"
            alt="Profile"
            class="header-icon"
          />
          <img
            src="/src/images/Menu icon.svg"
            alt="Menu"
            class="header-icon"
      ...
      <div class="mobile-menu" v-show="showMobileMenu">
        ...
        <div class="menu-content">
          <section>
            <h3>Profile</h3>
            <p>
              <img src="/src/images/Profile icon.svg" alt="" /> Log in or sign
              up
            </p>
            <p>
              <img
            ...
            <p>
              <img src="/src/images/manage bookings icon.svg" alt="" /> Manage
              bookings
            </p>
          </section>
          <section>
            <h3>Explore</h3>
            <p>
              <img src="/src/images/Discover icon in mobile menu.svg" alt="" />
            ...
            <p>
              <img src="/src/images/Places icon in mobile menu.svg" alt="" />
              Places
              <img
                class="arrow-menu"
                src="/src/images/arrow right.svg"
          ...
          <section>
            <p>
              <img src="/src/images/support icon.svg" alt="" /> Support
              <img
                class="arrow-menu"
                src="/src/images/arrow right.svg"
                alt=""
            ...
            <p>
              <img src="/src/images/Currency icon.svg" alt="" /> Currency:
              Pakistani rupees
              <img
                class="arrow-menu"
                src="/src/images/arrow right.svg"
